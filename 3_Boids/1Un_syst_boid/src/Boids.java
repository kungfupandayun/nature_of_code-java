...
public class Boids{
 ...
 /*création d'une liste de pots*/
  ...
  /*On positionne les balles dans des endroits aléa*/
...
public void behaviour(Vecteur b,Vecteur target,LinkedList<Vecteur> boids){
  //PARAMETRE(LinkedList<Vecteur> boids,int maxforce,int cover_distance)
